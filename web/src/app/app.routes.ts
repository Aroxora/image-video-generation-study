...
export const routes: Routes = [
  { path: '', loadComponent: () => import('./features/overview/overview').then((m) => m.Overview), title: 'Erosolar — Image & Video Generation' },
  ...
  { path: 'studio', loadComponent: () => import('./features/studio/studio').then((m) => m.Studio), title: 'Erosolar Image Studio' },
  { path: '**', redirectTo: '' },
];
